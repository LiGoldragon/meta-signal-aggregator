...
Claude, Codex, Pi, or repository sources; it does not implement collection; it
does not store daemon state. The runtime daemon imports these types and applies
configuration through its meta Signal/Nexus/SEMA path.
